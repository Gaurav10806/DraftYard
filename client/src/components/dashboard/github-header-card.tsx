...
export function GithubHeaderCard() {
  ...
  return (
    <div className="flex flex-col md:flex-row md:items-center gap-3 md:gap-3.5 rounded-2xl border border-border/80 bg-card/60 p-3.5 md:px-4 md:py-2.5 shadow-sm backdrop-blur-sm max-w-md w-full shrink-0">
      {!isConnected ? (
        <>
          <div className="flex items-start md:items-center gap-3 min-w-0 flex-1">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-[11px] text-muted-foreground leading-snug line-clamp-2 md:truncate">
          ...
          <Button
            ...
            disabled={connecting}
            className="h-8 w-full md:w-auto shrink-0 gap-1.5 rounded-xl text-xs font-medium px-3 shadow-none mt-1 md:mt-0"
          >
            {connecting ? (
        ...
        <>
          ...
          <Button
            ...
            className="h-8 w-full md:w-auto shrink-0 text-xs font-medium rounded-xl border-border px-3 hover:bg-accent mt-1 md:mt-0"
          >
            Manage
          </Button>
        </>
