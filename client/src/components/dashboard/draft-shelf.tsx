...
export function DraftShelf() {
  ...
  // Show the user's own drafts first when logged in, fall back to feed or static
  const items = (
        ...
        >
          {items.map((d, i) => {
            ...
            return (
              <div
                key={d.projectName}
                onClick={() => openDraft(d.projectName)}
                ...
                <div className="flex items-center justify-between">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" onClick={(e) => e.stopPropagation()}>
                      <DropdownMenuItem onClick={() => openDraft(d.projectName)}>
                        Open
                      </DropdownMenuItem>
                      <DropdownMenuItem
                      ...
                      <DropdownMenuItem
                        onClick={() => {
                          const url = `${window.location.origin}/project/${slugify(d.projectName)}`;
